...
trait IntImplicits {
  implicit def RichInt(n: Int): RichInt = new com.github.kmizu.nscala.time.RichInt(n)
  implicit def RichLong(n: Long): RichLong = new com.github.kmizu.nscala.time.RichLong(n)
}
